...
bin/src: build/main.o build/board_initialization.o build/move.o build/decode.o build/output.o 
	gcc -Wall -Werror build/main.o build/board_initialization.o build/move.o build/decode.o build/output.o -o bin/src
